# Generated by Powerlevel10k configuration wizard on 2025-02-11 at 10:31 PST.
...
# flat tails, 2 lines, solid, no frame, sparse, many icons, concise, transient_prompt,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # direnv                  # direnv status (https://direnv.net/) (▼ when direnv active)
    asdf                    # asdf version manager (https://github.com/asdf-vm/asdf)
    virtualenv              # python virtual environment (https://docs.python.org/3/library/venv.html)
    anaconda                # conda environment (https://conda.io/)
    pyenv                   # python environment (https://github.com/pyenv/pyenv)
    goenv                   # go environment (https://github.com/syndbg/goenv)
    # nodenv                  # node.js version from nodenv (https://github.com/nodenv/nodenv) (⬢ version)
    ...
    # rbenv                   # ruby version from rbenv (https://github.com/rbenv/rbenv) ( version)
    ...
    #azure                   # azure account name (https://docs.microsoft.com/en-us/cli/azure) (Conflicts with Terraform)
  ...
  # Change to quiet so for use in IntelliJ where terminal opens in a directory that causes direnv
  # to output loading messages.
